...
/**
 * ProductCard - Compact product card with modern design
 * Shows product image, details, and add to cart
 */
export const ProductCard = ({ product, onAddToCart, isAdding = false, onScanAnother }) => {
